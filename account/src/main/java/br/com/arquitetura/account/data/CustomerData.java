...
import br.com.arquitetura.account.exception.CustomerFieldRequiredException;
...
public class CustomerData extends ValidationFiedsData{
	...
	protected void validateRequiredUid() {
		if(uid == null) {
			throw new CustomerFieldRequiredException("uid");
		}
	}
	...
	private void validateRequiredFields() {
		if(StringUtils.isEmpty(whatsapp) && StringUtils.isEmpty(personalPhone) && StringUtils.isEmpty(comercialPhone)) { 
			throw new CustomerFieldRequiredException(new String[] {"whatsapp", "personalPhone", "comercialPhone"});
		}
	} 
}
